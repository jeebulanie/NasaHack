...
import turk from "../imageStrike/turkce.png";
...
const Turkey = () => {
  ...
  return (
    <div className="flex">
      <img className="w-2/3 mx-auto ml-6" src={turk} alt="turkey" />
      <div>
        <div className="flex form-control flex-col ml-6 w-38">
        ...
        <div className="mx-40 mt-14 ml-40 h-36 w-36">
