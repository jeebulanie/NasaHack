...
import "../planets/SolarExplorer.css";
        ...
        <div className="solar_systm">
          <div className="planet earth">
            ...
            <div className="planet_description earth">
              <h2>Planet</h2>
              <h1 onClick={() => navigate("/sam")} className="cursor-pointer">
                Earth
              </h1>
              <p>
